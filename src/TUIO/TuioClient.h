...
namespace TUIO {
	...
	public:
		 ...
		 */
		 ...
		 TuioObject* getTuioObjectBySymbolID(long s_id);
		 /*
            RETURNS THE TUIOOBJECT CORRESPONDING TO THE PROVIDED SYMBOL ID
            OR NULL IF THE SYMBOL ID DOES NOT REFER TO AN ACTIVE TUIOOBJECT
		 */
